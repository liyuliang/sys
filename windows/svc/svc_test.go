...
import (
	...
	"github.com/liyuliang/sys/windows/svc"
	"github.com/liyuliang/sys/windows/svc/mgr"
)
...
func TestExample(t *testing.T) {
	...
	o, err := exec.Command("go", "build", "-o", exepath, "github.com/liyuliang/sys/windows/svc/example").CombinedOutput()
	if err != nil {
